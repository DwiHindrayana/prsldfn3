...
async def addchannel(client, message):
    ...
    try:
        ...
        await USER.send_message(message.chat.id, "Gua Join atas pemintaan anda yang mulia")
    except UserAlreadyParticipant:
        await message.reply_text(
            "<b>budak prisil udah ada di grup</b>",
        )
...
async def addcchannel(client, message):
    ...
    try:
        await USER.join_chat(invitelink)
        await USER.send_message(message.chat.id, "Gua join atas pemintaan yang mulia")
    except UserAlreadyParticipant:
        await message.reply_text(
